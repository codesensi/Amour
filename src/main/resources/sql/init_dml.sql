...
FROM (
         VALUES
             ...
             (1701, 1700, '登录日志分页查询', 'B', NULL, NULL, 1, NULL, 'system:log-login:page', 1),
             (1702, 1700, '操作日志分页查询', 'B', NULL, NULL, 2, NULL, 'system:log-operate:page', 1),
             ...
             (2000, 0, '点点滴滴', 'M', '/admin/moments', 'admin/moments/index', 2, 'ep:sunny', NULL, 1),
             (2001, 2000, '分页查询', 'B', NULL, NULL, 1, NULL, 'admin:moments:page', 1),
             (2002, 2000, '增加', 'B', NULL, NULL, 2, NULL, 'admin:moments:insert', 1),
             (2003, 2000, '修改', 'B', NULL, NULL, 3, NULL, 'admin:moments:update', 1),
             (2004, 2000, '删除', 'B', NULL, NULL, 4, NULL, 'admin:moments:delete', 1),
             (2100, 0, '恋爱画册', 'M', '/admin/love-photo', 'admin/love-photo/index', 3, 'ep:camera', NULL, 1),
             (2101, 2100, '分页查询', 'B', NULL, NULL, 1, NULL, 'admin:love-photo:page', 1),
             (2102, 2100, '增加', 'B', NULL, NULL, 2, NULL, 'admin:love-photo:insert', 1),
             (2103, 2100, '修改', 'B', NULL, NULL, 3, NULL, 'admin:love-photo:update', 1),
             (2104, 2100, '删除', 'B', NULL, NULL, 4, NULL, 'admin:love-photo:delete', 1),
             (2200, 0, '恋爱清单', 'M', '/admin/love-list', 'admin/love-list/index', 4, 'ep:list', NULL, 1),
             (2201, 2200, '分页查询', 'B', NULL, NULL, 1, NULL, 'admin:love-list:page', 1),
             (2202, 2200, '增加', 'B', NULL, NULL, 2, NULL, 'admin:love-list:insert', 1),
             (2203, 2200, '修改', 'B', NULL, NULL, 3, NULL, 'admin:love-list:update', 1),
             (2204, 2200, '删除', 'B', NULL, NULL, 4, NULL, 'admin:love-list:delete', 1),
             (2300, 0, '留言簿', 'M', '/admin/message', 'admin/message/index', 5, 'ep:chat-dot-round', NULL, 1),
             (2301, 2300, '分页查询', 'B', NULL, NULL, 1, NULL, 'admin:message:page', 1),
             (2302, 2300, '增加', 'B', NULL, NULL, 2, NULL, 'admin:message:insert', 1),
             (2303, 2300, '修改', 'B', NULL, NULL, 3, NULL, 'admin:message:update', 1),
             (2304, 2300, '删除', 'B', NULL, NULL, 4, NULL, 'admin:message:delete', 1),
             (2400, 0, '纪念日', 'M', '/admin/anniversary', 'admin/anniversary/index', 6, 'ep:calendar', NULL, 1),
             (2401, 2400, '分页查询', 'B', NULL, NULL, 1, NULL, 'admin:anniversary:page', 1),
             (2402, 2400, '增加', 'B', NULL, NULL, 2, NULL, 'admin:anniversary:insert', 1),
             (2403, 2400, '修改', 'B', NULL, NULL, 3, NULL, 'admin:anniversary:update', 1),
             (2404, 2400, '删除', 'B', NULL, NULL, 4, NULL, 'admin:anniversary:delete', 1),
             (2500, 0, '时间胶囊', 'M', '/admin/time-capsule', 'admin/time-capsule/index', 7, 'ep:box', NULL, 1),
             (2501, 2500, '分页查询', 'B', NULL, NULL, 1, NULL, 'admin:time-capsule:page', 1),
             (2502, 2500, '增加', 'B', NULL, NULL, 2, NULL, 'admin:time-capsule:insert', 1),
             (2503, 2500, '修改', 'B', NULL, NULL, 3, NULL, 'admin:time-capsule:update', 1),
             (2504, 2500, '删除', 'B', NULL, NULL, 4, NULL, 'admin:time-capsule:delete', 1),
             (2600, 0, '情侣日志', 'M', '/admin/diary', 'admin/diary/index', 8, 'ep:notebook', NULL, 1),
             (2601, 2600, '分页查询', 'B', NULL, NULL, 1, NULL, 'admin:diary:page', 1),
             (2602, 2600, '增加', 'B', NULL, NULL, 2, NULL, 'admin:diary:insert', 1),
             (2603, 2600, '修改', 'B', NULL, NULL, 3, NULL, 'admin:diary:update', 1),
             (2604, 2600, '删除', 'B', NULL, NULL, 4, NULL, 'admin:diary:delete', 1),
             (2700, 0, '足迹', 'M', '/admin/footprint', 'admin/footprint/index', 9, 'ep:location', NULL, 1),
             (2701, 2700, '分页查询', 'B', NULL, NULL, 1, NULL, 'admin:footprint:page', 1),
             (2702, 2700, '增加', 'B', NULL, NULL, 2, NULL, 'admin:footprint:insert', 1),
             (2703, 2700, '修改', 'B', NULL, NULL, 3, NULL, 'admin:footprint:update', 1),
             (2704, 2700, '删除', 'B', NULL, NULL, 4, NULL, 'admin:footprint:delete', 1),
             (3000, 0, '个人中心', 'M', '/admin/profile', 'profile/index', 10, 'ep:avatar', NULL, 1)
